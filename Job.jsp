...
<div >
 <nav class ="navbar"  role="navigation" aria-label="Primary site navigation">
      ...
      <a href="#update-company" tabindex="0">UPDATE_COMPANY</a>
...
<h2 class="text-primary"> JOB FORM</h2>
...
<input type="text" class="form-control" name="job_name" placeholder="JOB NAME"/>
 <select id="job_type" name="job_type" aria-label="Job Type" >
...
<input type="text" class="form-control" name="valid_upto" placeholder="VALID UPTO"/>
