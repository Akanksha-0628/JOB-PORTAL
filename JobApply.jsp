...
<main class="form-container">
  ...
  <form class="apply-form" action="JobApplyServlet" method="post" enctype="multipart/form-data">
    <h2 class="text-primary">APPLY FOR JOB</h2>
    ...
    <textarea class="form-control" name="coverletter" placeholder="COVER LETTER"></textarea>

    <input id="apply_btn" type="submit" value="APPLY NOW"/>
  </form>
