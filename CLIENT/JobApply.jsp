...
<p style="font-size: 12px; font-weight: 600;  color: #2f78bd; margin-bottom: 5px; display: block;">Apply Date</p>

<input type="date" class="form-control" name="apply date"   placeholder="APPLY DATE " aria-label="APPLY DATE" />
<input  id="updt_btn" type="submit" class="btn btn-outline-primary" value="APPLY"/>
</form>
</div>
</main>
</body>
